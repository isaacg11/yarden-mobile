                    ...
                    <View style={{ padding: units.unit3 + units.unit4 }}>
                        <View style={{ height: '100%', display: 'flex', justifyContent: 'center' }}>
                            ...
                            <View style={{paddingHorizontal: units.unit6}}>
                                ...
                                <Text style={{textAlign: 'center'}}>{formatWateringSchedule(wateringSchedule[wateringSchedule.length - 1].result)}</Text>
                            </View>
...
WateringSchedule = connect(mapStateToProps, mapDispatchToProps)(WateringSchedule);
