            ...
            <KeyboardAvoidingView behavior="padding">
                <Card style={{
                    ...
                    <View style={{ alignItems: 'center' }}>
                        ...
                        />
                        <Header style={{ color: colors.purpleB }}>{selectedPlant.id.name} {selectedPlant.id.common_type.name}</Header>
                    ...
                    <View style={{
                        ...
                        <View>
                            <Label>Planted:</Label>
                            <Paragraph>{moment(selectedPlant.dt_planted).format('MM/DD/YY')}</Paragraph>
                        </View>
                        <View>
                            <Label>Season:</Label>
                        ...
                        <View>
                            ...
                            {daysToMature < 1 ? (
                                ...
                                <Paragraph>{daysToMature} {(daysToMature > 1) ? 'days' : 'day'}</Paragraph>
                            )}
                ...
                <KeyboardAwareScrollView style={{ backgroundColor: colors.greenE10, height: '100%', paddingHorizontal: units.unit4, paddingVertical: units.unit4 }}>
                    ...
                    {/* new note input (dynamically visible) */}
                    {(isCreatingNote) && (
                    ...
                    {notes.map((note, index) => (
                        <View key={index} style={{ paddingTop: units.unit4 }}>
                            <Divider />
                            <View style={{ display: 'flex', flexDirection: 'row', paddingVertical: units.unit4 }}>
                                <Image
                                    source={{
                                ...
                                <View style={{ paddingLeft: units.unit3 }}>
                                    <Text style={{ textTransform: 'capitalize' }}>{note.owner.first_name} {note.owner.last_name[0]}.</Text>
