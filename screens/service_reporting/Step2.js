...
class Step2 extends Component {
    ...
    componentDidMount() {
        const questionIndex = this.props.questions.findIndex((question) => question.placement === 2);
    ...
    async next(result) {
        ...
        if (result === true) {
            ...
            this.props.navigation.navigate('Beds', {
                ...
                serviceReport: types.HARVESTED_PLANTS
            })
        } else { // if user answered no {...}
            // redirect user to next screen
            this.props.navigation.navigate('Step 3');
        }
    }
...
Step2 = connect(mapStateToProps, mapDispatchToProps)(Step2);
